...
export class TabPanel{
    ...
    render(){
        ...
        this.titleViews=this.children.map((child,i)=><span onClick={()=>this.select(i)} style="background-color:lightgreen;margin:5px 5px 0px 5px;font-size:24px;width:300px;min-height:300px;">{child.getAttribute("title")||" "}</span>)
